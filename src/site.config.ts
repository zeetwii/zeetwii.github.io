...
const config: SiteConfig = {
  ...
  site: 'https://zeetwii.github.io/',
  // The name of your site, used in the title and for SEO.
  title: 'ZeeTwii',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A personal blog about my latest projects, thoughts, and other silly things',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Nick Ashworth',
  // Keywords for SEO, used in the meta tags.
  tags: ['Hacking', 'AI', 'Cyber', 'Robotics', 'zeetwii', 'blog', 'personal'],
  ...
  socialLinks: {
    github: 'https://github.com/zeetwii',
    linkedin: 'https://www.linkedin.com/in/james-ashworth-5a49bb266/',
    bluesky: 'https://bsky.app/profile/zeetwii.bsky.social',
    youtube: 'https://www.youtube.com/@ZeeTwii',
